...
if (fs::file_exists("R/spatial_model_comparison.R")) {
  tryCatch({
    source("R/spatial_model_comparison.R")
...
if (fs::file_exists("R/fuzzing_effect_analysis.R")) {
  tryCatch({
    source("R/fuzzing_effect_analysis.R")
...
if (fs::file_exists("R/sensor_resolution_comparison.R")) {
  tryCatch({
    source("R/sensor_resolution_comparison.R")
    results$sensor <- TRUE
    cat("   ✓ Complete\n\n")
  }, error = function(e) {
    cat("   ✗ Failed:", e$message, "\n\n")
...
if (fs::file_exists("R/landscape_heterogeneity_analysis.R")) {
  tryCatch({
    source("R/landscape_heterogeneity_analysis.R")
...
if (fs::file_exists("R/create_prediction_maps.R")) {
  tryCatch({
    source("R/create_prediction_maps.R")
    results$maps <- TRUE
    cat("   ✓ Complete\n\n")
  }, error = function(e) {
    cat("   ✗ Failed:", e$message, "\n\n")
